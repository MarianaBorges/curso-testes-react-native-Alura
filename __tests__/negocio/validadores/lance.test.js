...
describe("negocio/validadores/lance", ()=> {
    describe('validaLance', ()=> {
        it('deve retornar VALIDO quando o valor for maior que o lance do leilão', ()=>{
            const valorLance = 30;
            const leilao = {
                valorInicial : 10,
                lances: [
        ...
        it('deve retornar VALIDO quando o valor for igual ao valor inicial do leilao', () => {
            const valorLance = 10;
            const leilao = {
                valorInicial: 10,
                lances: [],
        ...
        it('deve retornar VALIDO quando o valor for maior que o valor inicial do leilao', ()=>{
            const valorLance = 20;
            const leilao = {
                valorInicial : 10,
                lances: [],
    ...
    describe('validaFormatoNumericoDoLance', () => {
        ...
        it('deve retornar VALIDO quando o valor for um número decimal com virgula', () => {
            const valorEmTexto = '123,45';
            const resultado = validaFormatoNumericoDoLance(valorEmTexto);
            expect(resultado).toBe(VALIDO);
        });

        it('deve retornar INVALIDO quando o valor for um número decimal com virgula', () => {
            const valorEmTexto = '123.45';
            const resultado = validaFormatoNumericoDoLance(valorEmTexto);
